...
function checkForWinner() {
  ...
  if (
    ...
    (sqs.s1 == sqs.s4 && sqs.s1 == sqs.s7) ||
    (sqs.s1 == sqs.s5 && sqs.s1 == sqs.s9) ||
    (sqs.s2 == sqs.s5 && sqs.s2 == sqs.s8) ||
    (sqs.s3 == sqs.s6 && sqs.s3 == sqs.s9) ||
    (sqs.s3 == sqs.s5 && sqs.s3 == sqs.s7) ||
    (sqs.s4 == sqs.s5 && sqs.s4 == sqs.s6) ||
    (sqs.s7 == sqs.s8 && sqs.s7 == sqs.s9)
  ) {
    XO == "X" ? (XO = "O") : (XO = "X");
